...
def imagen_global(netcdf_file = '../netCDF/1990.nc', V = 'pr'):
...
def extraccion_region(netcdf_file = '../netCDF/1990.nc',lat_min = 4, lat_max= 10, lon_min = 282 , lon_max = 287 , n = 3 , V= 'pr'):
